...
//#define RFM12_INT_MSK GICR	// Atmega8
#define RFM12_INT_MSK EIMSK	// Atmega168

//the interrupt bit in the mask register
#define RFM12_INT_BIT (INT1)

//the interrupt flag register
//#define RFM12_INT_FLAG GIFR 	// Atmega8
 ...
 */
#define USE_ARDUINO_INT 0  // use the arduino interrupt config
